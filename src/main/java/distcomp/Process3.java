...
public class Process3 extends Thread {
    ...
    public Process3() throws JMSException {
        rand = new Random();
    ...
    public void run() {
        try {
            ...
            while (true) {
                ...
                TextMessage message = session.createTextMessage("Request " + requestN + " from Process 3");
                ...
                System.out.println("Process 3: " + res);

                message = session.createTextMessage("Request " + requestN++ + " finished by Process 3");
